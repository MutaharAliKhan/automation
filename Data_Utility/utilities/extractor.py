...
#         return data_providers[provider_func_name]()
#     else:
...
#                 combined_df = pd.concat([first_row, data_frame], ignore_index=True)
...
#                     initial_row_count = len(data_frame)
#                     update_csv(csv_path, data_frame)
#                     if not data_frame.empty:
