...
def read_values_from_csv():
    pre_req_user_setup()
    df = pd.read_csv(r"D:\MyRecentProjects\Data_Utility\system_generated_scripts\second\test_script_2.csv")
...
@allure.feature('script_2')
@allure.story('script_2')
@allure.title('script_2')
