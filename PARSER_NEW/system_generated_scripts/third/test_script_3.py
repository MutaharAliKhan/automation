...
def read_values_from_csv():
    pre_req_user_setup()
    df = pd.read_csv(r"D:\MyRecentProjects\Data_Utility\system_generated_scripts\third\test_script_3.csv")
...
@allure.feature('script_3')
@allure.story('script_3')
@allure.title('script_3')
